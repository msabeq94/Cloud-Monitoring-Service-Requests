...
(yes/no) "
        ...
        $RMResourceGroup = Get-AzResourceGroup -Name $newResourceGroupName
...
}while ($RMResourceGroup -eq "yes" -or $addResourceGroup -eq "y" -or [string]::IsNullOrEmpty($addResourceGroup))
